...
| 그래프가 왼쪽부터 **그려지듯** 드러난다 | 3·4쪽 | 결과를 한 번에 던지지 않는다 |
...
| 계획선이 **그어진다** | 12쪽 | 순서가 곧 일정이다 |

그 위에 배경 질감을 얹었습니다 (`rep5x-fx.js`) — reactbits.dev 를 참고해
React 없이 Canvas2D + CSS 로 다시 구현한 것입니다.
...
rep5x-fx.js         # 배경 질감 (Galaxy·Ballpit·Fuzzy·ASCII·Magnet·Tilt·Splash)
