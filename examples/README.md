...
| `lamp_banded.gcode` | `python3 conical_slice.py examples/lamp.stl --auto-bands 2 --layer-height 0.4` 출력. 경계가 자동으로 목(z 15.00→17.63)으로 옮겨가 블렌드가 2.3mm 로 끝난다 — 층간격 배율 1.50배(상한 준수) |
